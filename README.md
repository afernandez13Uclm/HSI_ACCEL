...
5. **Instantiate the accelerator in hw/peripherals/gr_heep_peripherals.sv.tpl**
    ```SystemVerilog
        ...
        // FIFO signals (driven by HSI OBI module)
        ...
        hsi_accel_obi #(
            ...
            // FIFO interfaces connected internally
            .in1_wr_en_o  (hsi_in1_wr_en),
            .in2_wr_en_o  (hsi_in2_wr_en),
            .in1_data_o   (hsi_in1_data),
            .in2_data_o   (hsi_in2_data),
            .out_rd_en_i  (hsi_out_rd_en),
            .out_empty_o  (hsi_out_empty),
            .out_data_o   (hsi_out_data)
        );

        // Assign FIFO input unused by default
